...
import { Button, Icon, Item, Label, List, Form, Card, Modal} from 'semantic-ui-react'
...
class SavedCocktailModal extends Component {
...
export default connect(msp, mdp)(SavedCocktailModal);